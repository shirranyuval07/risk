...
public class Board {
    ...
    private void loadBoardFromJson()
    {
        try (InputStream is = getClass().getResourceAsStream("/Board.json"))
        {
            ...
            double scale = GameConstants.MAP_GLOBAL_SCALE;
            double offsetX = GameConstants.MAP_GLOBAL_OFFSET_X;
            double offsetY = GameConstants.MAP_GLOBAL_OFFSET_Y;
            applyGlobalScale(scale, offsetX, offsetY);
